...
optionValueNoOptionType
    ...
    | charset (charsetName | {this.isServerVersionGe80011()}? DEFAULT_SYMBOL)
...
geometryFunction
    : (GEOMETRYCOLLECTION_SYMBOL | GEOMCOLLECTION_SYMBOL) OPEN_PAR_SYMBOL exprList? CLOSE_PAR_SYMBOL
